  ...
  return (
    <section id="hero" className="relative py-12 md:py-24 overflow-hidden bg-cream-bg text-brand-dark pt-32">
      ...
      <div className="absolute top-24 left-[8%] select-none z-10 pointer-events-none text-brand-orange hidden sm:block">
        <div className="relative group p-3 bg-white border-2 border-brand-dark rounded-xl shadow-[4px_4px_0_#2A1B15]">
          <Compass className="w-8 h-8" />
        </div>
      </div>

      <div className="absolute top-24 right-[12%] select-none z-10 pointer-events-none text-brand-green hidden sm:block">
        <div className="p-3 bg-white border-2 border-brand-dark rounded-full shadow-[4px_4px_0_#2A1B15]">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-4 flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="px-8 py-4 bg-brand-orange text-white text-base sm:text-lg font-kids font-bold rounded-full border-2 border-brand-dark shadow-[5px_5px_0_#2A1B15] hover:bg-brand-orange/95 hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all cursor-pointer inline-flex items-center gap-2 shrink-0"
            >
            ...
            <Link
              to="/tentang"
              className="px-8 py-4 bg-white text-brand-dark text-base sm:text-lg font-kids font-bold rounded-full border-2 border-brand-dark shadow-[5px_5px_0_#2A1B15] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all cursor-pointer inline-flex items-center gap-2 shrink-0"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-12 mt-16 md:mt-24 max-w-6xl mx-auto">
          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute -bottom-4 -left-4 z-30 select-none text-brand-dark">
              <div className="bg-white p-3 rounded-full border-2 border-brand-dark shadow-[3px_3px_0_#2A1B15] flex items-center justify-center">
            ...
            <div className="relative w-[280px] h-[380px] flex items-end justify-center group mt-8">
              ...
              <div className="absolute bottom-0 w-full h-[320px] bg-brand-green rounded-[140px_140px_30px_30px] border-4 border-brand-dark shadow-[8px_8px_0_#2A1B15] z-0" />
          ...
          <div className="bg-white/50 p-6 rounded-3xl border-2 border-brand-dark flex flex-col items-center text-center space-y-4 max-w-sm mx-auto shadow-[4px_4px_0_#2A1B15]">
            ...
            <div className="flex gap-1">
              <Star className="w-4 h-4 fill-brand-yellow stroke-brand-dark" />
              <Star className="w-4 h-4 fill-brand-yellow stroke-brand-dark" />
              <Star className="w-4 h-4 fill-brand-yellow stroke-brand-dark" />
              <Star className="w-4 h-4 fill-brand-yellow stroke-brand-dark" />
              <Star className="w-4 h-4 fill-brand-yellow stroke-brand-dark" />
          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute -bottom-2 -right-2 z-30 select-none text-brand-dark">
              <div className="bg-white p-3 rounded-full border-2 border-brand-dark shadow-[3px_3px_0_#2A1B15]">
            ...
            <div className="relative w-[280px] h-[380px] flex items-end justify-center group mt-8">
              ...
              <div className="absolute bottom-0 w-full h-[320px] bg-brand-yellow rounded-[40px_140px_140px_40px] border-4 border-brand-dark shadow-[8px_8px_0_#2A1B15] z-0" />
    ...
    {/* Dark Chocolate Statistics Banner */}
      <div className="py-12 px-4 max-w-7xl mx-auto z-20 relative mt-16 md:mt-24">
        <div className="bg-brand-dark text-[#FAF6F0] rounded-[2.5rem] p-8 md:p-12 border-4 border-brand-dark relative overflow-hidden shadow-[8px_8px_0_rgba(42,27,21,0.15)]">
            ...
            {HERO_STATS.map((stat, idx) => {
              ...
              return (
                <div key={idx} className="flex items-start gap-4 p-4 md:px-8 first:pl-0 last:pr-0">
                  <span className={`p-3.5 ${badgeColor} rounded-2xl border-2 border-brand-dark shrink-0 shadow-[2px_2px_0_#FAF6F0]`}>
