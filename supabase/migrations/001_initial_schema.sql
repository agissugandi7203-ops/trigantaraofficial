-- ============================================================================
-- Trigantara — Migrasi 001: Skema Awal
-- ============================================================================
-- Migrasi ini bersifat idempoten (aman dijalankan berulang kali).
-- Jalankan di: Supabase Dashboard → SQL Editor → New Query → Run
--
-- Catatan: jika database Anda sudah pernah dibuat dengan `supabase-schema.sql`
-- versi lama, file ini akan berjalan tanpa efek apa pun (semua CREATE memakai
-- IF NOT EXISTS). Lanjutkan ke migrasi 002.
-- ============================================================================
...
INSERT INTO site_settings (key, value) VALUES
  ...
  ('social',  '{"instagram": "https://instagram.com/Trigantara_official14"}'::jsonb)
...
-- RLS diaktifkan & seluruh kebijakan didefinisikan ulang di migrasi 002.
